...
// WALLET CONSTANTS
export const WALLET_STATISTICS_SUCCESS = 'WALLET_STATISTICS_SUCCESS';
export const WALLET_ACTIVITIES_SUCCESS = 'WALLET_ACTIVITIES_SUCCESS';
export const BILLING_SUCCESS = 'BILLING_SUCCESS';
export const WALLET_CARDS_SUCCESS = 'WALLET_CARDS_SUCCESS';
export const CLIENTS_IP = 'CLIENTS_IP';
